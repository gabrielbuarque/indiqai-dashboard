...
import '/components/criar_cupom_copy/criar_cupom_copy_widget.dart';
...
class SenhaAdminAtualizarWidget extends StatefulWidget {
  const SenhaAdminAtualizarWidget({
    super.key,
    required this.id,
  });
  ...
  @override
  State<SenhaAdminAtualizarWidget> createState() =>
      _SenhaAdminAtualizarWidgetState();
}

class _SenhaAdminAtualizarWidgetState extends State<SenhaAdminAtualizarWidget> {
  late SenhaAdminAtualizarModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SenhaAdminAtualizarModel());
